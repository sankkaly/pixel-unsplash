  ...
  return (
    <>
        <div className='py-2 flex justify-between w-full shadow-md '>
          <a href="https://pixel-unsplash.netlify.app/" className='text-2xl pl-2 md:text-4xl font-bold'>PIXEL</a>
          <div className='flex mr-4 md:mr-32 h-8 md:h-12 w-[250px] sm:w-[400px] md:w-[500px] lg:w-[700px] rounded-md border border-black bg-gray-100'>
            ...
            <button onClick={()=>{setOrientation('portrait')}} className='flex justify-center items-center'><CiMobile3 className='h-6 w-7'/></button>
